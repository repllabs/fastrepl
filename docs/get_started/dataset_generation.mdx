...
### Local
If you don't provide `api_key`, it will run on local machine.
...
4. Workload is distributed across auto-scaling containers, so it can **handle huge inputs.**

<Note>You can grab a key from here.</Note>
